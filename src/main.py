...
LINE_TO_ID_PERSONAL = os.getenv("LINE_TO_ID_PERSONAL")  # CTKÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ§ÃÂÃÂ¨ÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂÃÂ¤ÃÂºÃÂºLINEÃÂ¯ÃÂ¼ÃÂ
COWORK_WEBHOOK_TOKEN = os.getenv("COWORK_WEBHOOK_TOKEN", "")

# CTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¹URLÃÂ¯ÃÂ¼ÃÂRailway ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂµÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹URLÃÂ¯ÃÂ¼ÃÂ
...
# --- Polling Interval ---
POLL_INTERVAL_SECONDS = int(os.getenv("POLL_INTERVAL_SECONDS", "20"))  # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ20ÃÂ§ÃÂ§ÃÂ
...
def notify_ctk_expired() -> None:
    """Indeed CTK ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ LINE ÃÂ£ÃÂÃÂ¨ Slack ÃÂ£ÃÂÃÂ§ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ1ÃÂ£ÃÂÃÂµÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹ÃÂ¨ÃÂµÃÂ·ÃÂ¥ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­ÃÂ£ÃÂÃÂ«1ÃÂ¥ÃÂºÃÂ¦ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ"""
    global _ctk_expired_notified
    with _ctk_expired_notified_lock:
        if _ctk_expired_notified:
            return  # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ«ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿
        _ctk_expired_notified = True
    log("ALERT: Indeed CTK ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂLINE/Slack ÃÂ£ÃÂÃÂ«ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ")
    setup_url = f"{RAILWAY_SERVICE_URL}/update-ctk-setup?token={COWORK_WEBHOOK_TOKEN}"
    message = (
        "ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Indeed CTK ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ\n\n"
        "ÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ§ÃÂÃÂªÃÂ¥ÃÂÃÂ·ÃÂ£ÃÂÃÂ»ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ\n"
        "ÃÂ¢ÃÂÃÂ» ÃÂ¥ÃÂ¿ÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ¨ÃÂÃÂªÃÂ¤ÃÂ½ÃÂÃÂ£ÃÂÃÂ¯ÃÂ¥ÃÂ±ÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ¶ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ\n\n"
        "ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ¦ÃÂÃÂÃÂ©ÃÂ ÃÂÃÂ£ÃÂÃÂ\n"
        "ÃÂ¢ÃÂÃÂ  Chrome ÃÂ£ÃÂÃÂ§ jp.indeed.com ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ\n"
        "ÃÂ¢ÃÂÃÂ¡ ÃÂ£ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂ¥ÃÂ£ÃÂÃÂ ÃÂ¢ÃÂÃÂÃÂ£ÃÂÃÂCTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ\n"
        "ÃÂ¢ÃÂÃÂ¢ CTKÃÂ¥ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ¥ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¸ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ\n"
        "ÃÂ¢ÃÂÃÂ£ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ\n\n"
        "ÃÂ¢ÃÂÃÂ» ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂ\n"
        f"{setup_url}"
    )
    # SlackÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥
    notify_error_to_slack(message)
    # LINEÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂÃÂ¤ÃÂºÃÂºLINEÃÂ£ÃÂÃÂ«ÃÂ©ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ¡ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂªÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¯ÃÂ¼ÃÂ
    ...
    if LINE_CHANNEL_ACCESS_TOKEN and line_to_id:
        ...
        try:
            ...
            log(f"CTKÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ LINEÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥: status={resp.status_code}")
        except Exception as e:
            log(f"ERROR: CTKÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ LINEÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ ÃÂ¥ÃÂ¤ÃÂ±ÃÂ¦ÃÂÃÂ: {e}")
...
def extract_indeed_legacy_id(html: str) -> Optional[str]:
    """IndeedÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ®HTMLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂlegacyIdÃÂ¯ÃÂ¼ÃÂhexÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ½ÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
    IndeedÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¯ÃÂ¤ÃÂ»ÃÂ¥ÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂ®URLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂ«ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ:
    - https://employers.indeed.com/candidates/view?id=<legacyId>
    - https://engage.indeed.com/f/a/<legacyId>~~/... (ÃÂ¦ÃÂÃÂ§ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¥ÃÂ¼ÃÂ: hex)
    - https://engage.indeed.com/f/a/<base64url>~~... (ÃÂ¦ÃÂÃÂ°ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¥ÃÂ¼ÃÂ: base64url 22ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ­ÃÂ)
    legacyId ÃÂ£ÃÂÃÂ¯ hexÃÂ¦ÃÂÃÂÃÂ¥ÃÂ­ÃÂÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ8ÃÂ£ÃÂÃÂ20ÃÂ¦ÃÂ¡ÃÂÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ
    """
    if not html:
        return None
    # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³1: employers.indeed.com ÃÂ£ÃÂÃÂ«ÃÂ§ÃÂÃÂ´ÃÂ¦ÃÂÃÂ¥ id= ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂ«ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂ
    direct = re.search(r'employers\.indeed\.com/candidates(?:/view)?\?(?:[^"\'<>\s]*&)?id=([a-f0-9]{8,20})', html)
    if direct:
        return direct.group(1)
    # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³2: engage.indeed.com/f/a/<hex>~~ ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¥ÃÂ¼ÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂÃÂ§ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¥ÃÂ¼ÃÂÃÂ¯ÃÂ¼ÃÂ
    engage_hex = re.search(r'engage\.indeed\.com/f/a/([a-f0-9]{10,16})(?:~~|/)', html)
    if engage_hex:
        return engage_hex.group(1)
    # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³3: ÃÂ¤ÃÂ»ÃÂ»ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ®URLÃÂ£ÃÂÃÂ® id= ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¿ÃÂ¯ÃÂ¼ÃÂindeed ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
...
def extract_indeed_engage_urls(html: str) -> list:
    """IndeedÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ®HTMLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂengage.indeed.comÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ°URLÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂ¨ÃÂ£ÃÂÃÂ¦ÃÂ¦ÃÂÃÂ½ÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
    ÃÂ¦ÃÂÃÂ°ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¥ÃÂ¼ÃÂ(base64url)ÃÂ£ÃÂÃÂ»ÃÂ¦ÃÂÃÂ§ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¥ÃÂ¼ÃÂ(hex)ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ engage.indeed.com/f/a/ URLÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
    ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂURLÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ employers.indeed.com/candidates/view?id=<hex> ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
    """
    if not html:
        return []
    # engage.indeed.com/f/a/<ÃÂ¤ÃÂ»ÃÂ»ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ­ÃÂÃÂ¥ÃÂÃÂ>~~ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³
    matches = re.findall(r'(https://engage\.indeed\.com/f/a/[A-Za-z0-9_\-]{10,}~~[^\s"\'<>]*)', html)
    return list(dict.fromkeys(matches))  # ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¤ÃÂÃÂ©ÃÂÃÂ¤ÃÂ¥ÃÂÃÂ»ÃÂ¯ÃÂ¼ÃÂÃÂ©ÃÂ ÃÂÃÂ¥ÃÂºÃÂÃÂ¤ÃÂ¿ÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ

def extract_phone_number(html: str) -> Optional[str]:
    """ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ¬ÃÂ¦ÃÂÃÂHTMLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ§ÃÂÃÂªÃÂ¥ÃÂÃÂ·ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ½ÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ"""
    if not html:
        return None
    soup = BeautifulSoup(html, "html.parser")
    text = soup.get_text(separator="\n")
    # ÃÂ¦ÃÂÃÂ¥ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂ®ÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ§ÃÂÃÂªÃÂ¥ÃÂÃÂ·ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂÃÂºÃÂ¥ÃÂ¸ÃÂ¯ÃÂ£ÃÂÃÂ»ÃÂ¥ÃÂÃÂºÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ¯ÃÂ¼ÃÂ
    patterns = [
        r'0[789]0[-\s]?\d{4}[-\s]?\d{4}',  # ÃÂ¦ÃÂÃÂºÃÂ¥ÃÂ¸ÃÂ¯: 090/080/070
        r'0\d{1,4}[-\s]?\d{1,4}[-\s]?\d{4}',  # ÃÂ¥ÃÂÃÂºÃÂ¥ÃÂ®ÃÂ: 03-xxxx-xxxx ÃÂ§ÃÂ­ÃÂ
        r'0120[-\s]?\d{3}[-\s]?\d{3}',  # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«
    ]
...
def normalize_phone_number(phone: str) -> str:
    """+81ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¥ÃÂ¼ÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ¦ÃÂÃÂ¬ÃÂ¥ÃÂÃÂ½ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ½ÃÂ¢ÃÂ¥ÃÂ¼ÃÂ(0XX-XXXX-XXXX)ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ"""
    if not phone:
        return phone
    digits = re.sub(r'[\s\-\(\)]', '', phone)
    if digits.startswith('+81'):
        digits = '0' + digits[3:]
    if re.match(r'^0[789]0\d{8}$', digits):  # ÃÂ¦ÃÂÃÂºÃÂ¥ÃÂ¸ÃÂ¯ 090/080/070
        return f"{digits[:3]}-{digits[3:7]}-{digits[7:]}"
    if re.match(r'^0\d{9}$', digits):  # ÃÂ¥ÃÂÃÂºÃÂ¥ÃÂ®ÃÂ10ÃÂ¦ÃÂ¡ÃÂ
        return f"{digits[:2]}-{digits[2:6]}-{digits[6:]}"
    if re.match(r'^0120\d{6}$', digits):  # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«
        return f"{digits[:4]}-{digits[4:7]}-{digits[7:]}"
    return phone

def extract_body_text(html: str, max_chars: int = 500) -> str:
    """ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ¬ÃÂ¦ÃÂÃÂHTMLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ½ÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂ¤ÃÂ§max_charsÃÂ¦ÃÂÃÂÃÂ¥ÃÂ­ÃÂÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ"""
    if not html:
        return ""
    soup = BeautifulSoup(html, "html.parser")
    # script/styleÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¤ÃÂ¥ÃÂÃÂ»
    for tag in soup(["script", "style"]):
        tag.decompose()
    text = soup.get_text(separator="\n")
    # ÃÂ©ÃÂÃÂ£ÃÂ§ÃÂ¶ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ©ÃÂºÃÂ¨ÃÂ¡ÃÂÃÂ£ÃÂÃÂ1ÃÂ¨ÃÂ¡ÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
    lines = [line.strip() for line in text.splitlines() if line.strip()]
    result = "\n".join(lines)
    if len(result) > max_chars:
        result = result[:max_chars] + "ÃÂ¢ÃÂÃÂ¦"
    return result

def format_phone_for_slack(phone: str) -> str:
    """Format phone number as a Slack tel: link.
    Converts '+81 80 2478 7813' ÃÂ¢ÃÂÃÂ '<tel:+818024787813|080-2478-7813>'
    ...
    # Build Japanese local display format: +81 80 XXXX XXXX ÃÂ¢ÃÂÃÂ 080-XXXX-XXXX
    digits = tel_uri.lstrip("+")
    if digits.startswith("81") and len(digits) >= 11:
        local = "0" + digits[2:]  # 81 ÃÂ¢ÃÂÃÂ 0
...
def format_phone_for_line(phone: str) -> str:
    ...
    Converts '+81 80 2478 7813' ÃÂ¢ÃÂÃÂ '080-2478-7813'
...
def notify_slack_with_retry(
    ...
    if source == "indeed":
        lines = ["ÃÂ£ÃÂÃÂIndeed ÃÂ¦ÃÂÃÂ°ÃÂ§ÃÂÃÂÃÂ¥ÃÂ¿ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ"]
        lines.append(f"ÃÂ¦ÃÂ°ÃÂÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ{name}")
        if job_title:
            lines.append(f"ÃÂ¦ÃÂ±ÃÂÃÂ¤ÃÂºÃÂºÃÂ¯ÃÂ¼ÃÂ{job_title}")
        lines.append(f"ÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ¯ÃÂ¼ÃÂ{format_phone_for_slack(phone) if phone else 'ÃÂ¦ÃÂÃÂªÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²'}")
        lines.append(f"ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ{location if location else 'ÃÂ¦ÃÂÃÂªÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²'}")
        if email_addr:
            lines.append(f"ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ¯ÃÂ¼ÃÂ{email_addr}")
        if url:
            lines.append(f"URLÃÂ¯ÃÂ¼ÃÂ{shorten_url(url)}")
    else:
        lines = [f"ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¸ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ{name}ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ¿ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ"]
        if job_title:
            lines.append(f"ÃÂ¦ÃÂ±ÃÂÃÂ¤ÃÂºÃÂº: {job_title}")
        if phone:
            lines.append(f"ÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ§ÃÂÃÂªÃÂ¥ÃÂÃÂ·: {format_phone_for_slack(phone)}")
        if location:
            lines.append(f"ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂÃÂ: {location}")
        if email_addr:
            lines.append(f"ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«: {email_addr}")
        if answers:
            for ans in answers:
...
def notify_line_with_retry(
    ...
    if source == "indeed":
        ...
        if job_title:
            lines.append(f"ÃÂ¦ÃÂ±ÃÂÃÂ¤ÃÂºÃÂºÃÂ¯ÃÂ¼ÃÂ{job_title}")
        lines.append(f"ÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ¯ÃÂ¼ÃÂ{format_phone_for_line(phone) if phone else 'ÃÂ¦ÃÂÃÂªÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²'}")
        lines.append(f"ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ{location if location else 'ÃÂ¦ÃÂÃÂªÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²'}")
        if email_addr:
            lines.append(f"ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ¯ÃÂ¼ÃÂ{email_addr}")
        if url:
        ...
        lines = [f"ÃÂ£ÃÂÃÂ{name}ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¸ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ§ÃÂ¦ÃÂÃÂ°ÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ"]
        if job_title:
            lines.append(f"ÃÂ¦ÃÂ±ÃÂÃÂ¤ÃÂºÃÂº: {job_title}")
        if phone:
            lines.append(f"ÃÂ°ÃÂÃÂÃÂ ÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ§ÃÂÃÂªÃÂ¥ÃÂÃÂ·: {format_phone_for_line(phone)}")
        if location:
            lines.append(f"ÃÂ°ÃÂÃÂÃÂ ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂÃÂ: {location}")
        if email_addr:
            lines.append(f"ÃÂ°ÃÂÃÂÃÂ§ ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«: {email_addr}")
        if answers:
            for ans in answers:
                key = ans.get("questionKey", "")
                val = ans.get("value")
                if val and key:
                    lines.append(f"ÃÂ°ÃÂÃÂÃÂ {key}: {val}")
        if url:
            lines.extend(["", "ÃÂ¨ÃÂ©ÃÂ³ÃÂ§ÃÂ´ÃÂ°ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ:", shorten_url(url)])
...
def process_mail_by_uid(
    ...
    if source == "indeed":
        ...
        applicant_name = extract_name(from_header)
    # ÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ§ÃÂÃÂªÃÂ¥ÃÂÃÂ·ÃÂ£ÃÂÃÂ»ÃÂ¦ÃÂÃÂ¬ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ½ÃÂ¥ÃÂÃÂº
    phone = extract_phone_number(html)
    # IndeedÃÂ¥ÃÂ¿ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂ: URLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂlegacyIdÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ½ÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦APIÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂÃÂ¨ÃÂ¨ÃÂ©ÃÂ³ÃÂ§ÃÂ´ÃÂ°ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂ
    ...
    if source == "indeed":
        ...
        if legacy_id:
            ...
            # HTMLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ´ÃÂ¦ÃÂÃÂ¥hex IDÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂ:
            # engage.indeed.com ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ°URLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦hex IDÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
            ...
            for engage_url in engage_urls:
                ...
                if legacy_id:
                    ...
                    break
            if not legacy_id:
                # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯: extract_indeed_url ÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ±ÃÂÃÂ§ÃÂÃÂ¨URLÃÂ£ÃÂÃÂÃÂ¨ÃÂ©ÃÂ¦ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ
        ...
        if legacy_id:
            # legacyIdÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ®ÃÂ¡ÃÂ§ÃÂÃÂÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ¢URLÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂengage URLÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ»ÃÂ§ÃÂÃÂ­ÃÂ§ÃÂ¸ÃÂ®URLÃÂ§ÃÂÃÂ¨ÃÂ¯ÃÂ¼ÃÂ
            url = f"https://employers.indeed.com/candidates/view?id={legacy_id}"
            details = fetch_all_details(legacy_id)
            if not details:
                # ÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂÃÂÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂªAPIÃÂ©ÃÂÃÂÃÂ¥ÃÂ®ÃÂ³ÃÂ¥ÃÂ¯ÃÂ¾ÃÂ§ÃÂ­ÃÂ: 3ÃÂ§ÃÂ§ÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂ³ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¤ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂµÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
                log(f"fetch_all_details empty, retrying in 3s...")
                time.sleep(3)
                details = fetch_all_details(legacy_id)
            if details:
                phone = details.get("phone") or phone  # APIÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ¦ÃÂ­ÃÂ£ÃÂ§ÃÂ¢ÃÂº
                indeed_location = details.get("location")
                indeed_email = details.get("email")
                indeed_answers = details.get("answers") or []
                log(f"Indeed API details: phone={phone}, location={indeed_location}, answers={len(indeed_answers or [])}ÃÂ¤ÃÂ»ÃÂ¶")
            else:
                log(f"Indeed API returned no details for legacyId={legacy_id} after retry (CTK expired?)")
                # CTKÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ¤ÃÂÃÂ§ÃÂÃÂ¥ ÃÂ¢ÃÂÃÂ LINE/Slack ÃÂ£ÃÂÃÂ§ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ¯ÃÂ¼ÃÂ1ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¿ÃÂ¯ÃÂ¼ÃÂ
                try:
                    ...
                    pass
            # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯: phoneÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¦ÃÂ¤ÃÂÃÂ§ÃÂ´ÃÂ¢ÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂ£ÃÂÃÂ¥ÃÂ®ÃÂÃÂ¯ÃÂ¼ÃÂGraphQL APIÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ§ÃÂÃÂªÃÂ¥ÃÂÃÂ·ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
            if not phone:
    ...
    try:
        ...
        with imap_connection() as mail:
            ...
            if truly_new_uids:
                ...
                # ÃÂ¨ÃÂµÃÂ·ÃÂ¥ÃÂÃÂÃÂ§ÃÂÃÂ´ÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯: processed_ids ÃÂ£ÃÂÃÂÃÂ§ÃÂ©ÃÂº or ÃÂ¥ÃÂ°ÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ
                # ÃÂ¦ÃÂÃÂ¢ÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ "seen" ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂµÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
                # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¨ÃÂµÃÂ·ÃÂ¥ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂºÃÂÃÂ©ÃÂÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂ
                with _first_cycle_lock:
                    if not _first_cycle_done and len(processed_ids) == 0 and len(truly_new_uids) > 3:
                        ...
                        # ÃÂ¥ÃÂÃÂ¨ÃÂ¤ÃÂ»ÃÂ¶ÃÂ£ÃÂÃÂÃÂ¨ÃÂ»ÃÂ½ÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦gm:IDÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¿ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ¯ÃÂ¼ÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
...
# --- CTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¯ÃÂ¾ÃÂ¥ÃÂ¿ÃÂÃÂ¯ÃÂ¼ÃÂ ---
_CTK_UPDATE_FORM_HTML = """<!DOCTYPE html>
<html lang="ja">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  <title>Indeed CTK ÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°</title>
  <style>
...
<body>
  <h1>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Indeed CTK ÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°</h1>
  <p class="sub">ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂCTKÃÂ¥ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ¨ÃÂ²ÃÂ¼ÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ¤ÃÂ¤ÃÂ¸ÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂÃÂ³ÃÂ¥ÃÂÃÂÃÂ¦ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
  <form method="POST">
    <textarea name="ctk" placeholder="CTKÃÂ¥ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ²ÃÂ¼ÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ£ÃÂÃÂ..." autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
    <button type="submit">ÃÂ¢ÃÂÃÂ ÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
  </form>
  <div class="howto">
    <b>ÃÂ°ÃÂÃÂÃÂ CTKÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂ ÃÂÃÂ¯ÃÂ¼ÃÂPCÃÂ£ÃÂÃÂ®ChromeÃÂ£ÃÂÃÂ§ÃÂ¯ÃÂ¼ÃÂ</b>
    <ol>
      <li>jp.indeed.com ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³</li>
      <li>F12ÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯Ctrl+Shift+IÃÂ¯ÃÂ¼ÃÂÃÂ¢ÃÂÃÂ Application ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ ÃÂ¢ÃÂÃÂ Cookies ÃÂ¢ÃÂÃÂ jp.indeed.com</li>
      <li>ÃÂ£ÃÂÃÂCTKÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼</li>
      <li>ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¸ÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ²ÃÂ¼ÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ©ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ¡</li>
    </ol>
  </div>
  <div class="howto" style="margin-top:10px;">
    <b>ÃÂ°ÃÂÃÂÃÂ± ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂ</b>
    <ol>
      <li>PCÃÂ£ÃÂÃÂ®ChromeÃÂ£ÃÂÃÂ§ÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂÃÂ©ÃÂ ÃÂÃÂ£ÃÂÃÂ§CTKÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂ</li>
      <li>ÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ§ÃÂ­ÃÂÃÂ£ÃÂÃÂ§CTKÃÂ¥ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ</li>
    ...
    <p style="margin:8px 0 0;color:#888;font-size:12px;">ÃÂ¢ÃÂÃÂ» ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ¶ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ¯CookieÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ´ÃÂ¦ÃÂÃÂ¥ÃÂ§ÃÂ¢ÃÂºÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂPCÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ¿ÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
  </div>
  <script>
    (function() {
...
<head>
  ...
  <title>CTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ</title>
  <style>
...
<body>
  <div class="icon">ÃÂ¢ÃÂÃÂ</div>
  <h1>CTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ</h1>
  <p>Indeed APIÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂªÃÂÃÂ¨ÃÂ¨ÃÂ¼ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ<br>ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ¿ÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ»ÃÂ¨ÃÂ©ÃÂ±ÃÂ§ÃÂÃÂªÃÂ¥ÃÂÃÂ·ÃÂ£ÃÂÃÂ»ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ±ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
</body>
</html>"""

@flask_app.route("/update-ctk-setup", methods=["GET"])
def update_ctk_setup():
    """ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¸ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂCTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ¨ÃÂ£ÃÂÃÂ"""
    token = flask_request.args.get("token", "")
    if not COWORK_WEBHOOK_TOKEN or token != COWORK_WEBHOOK_TOKEN:
        return "Unauthorized", 401
    # ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂJSÃÂ¯ÃÂ¼ÃÂjp.indeed.comÃÂ£ÃÂÃÂ®CTKÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ¨ÃÂªÃÂ­ÃÂ£ÃÂÃÂ¿ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦POSTÃÂ©ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ¡ÃÂ¯ÃÂ¼ÃÂ
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  <title>CTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ° ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂ</title>
  <style>
    *{{box-sizing:border-box;}}
...
<body>
  <h1>ÃÂ¢ÃÂÃÂ¡ CTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ° ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂ</h1>
  <p class="sub">ÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂºÃÂ¦ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ¦ÃÂ¬ÃÂ¡ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ³1ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ§CTKÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>

  <div class="step">
    <span class="step-num">1</span><span class="step-title">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</span>
    <div class="step-body">
      ÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ<b>ÃÂ©ÃÂÃÂ·ÃÂ¦ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¥ÃÂÃÂ³ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¯ÃÂ¼ÃÂÃÂ¢ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂ</b>ÃÂ£ÃÂÃÂ§ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ<br>
      ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¯ <b>ÃÂ£ÃÂÃÂCTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂ</b> ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ¤ÃÂ¾ÃÂ¿ÃÂ¥ÃÂÃÂ©ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
      <a class="bm-link" href="{bookmarklet_js}">ÃÂ¢ÃÂ­ÃÂ CTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¯ÃÂ§ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ³ÃÂ¯ÃÂ¼ÃÂ</a>
    </div>
  </div>

  <div class="step">
    <span class="step-num">2</span><span class="step-title">CTKÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¢ÃÂÃÂ¦</span>
    <div class="step-body">
      ÃÂ¢ÃÂÃÂ  ChromeÃÂ£ÃÂÃÂ§ <b>jp.indeed.com</b> ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ°OKÃÂ¯ÃÂ¼ÃÂ<br>
      ÃÂ¢ÃÂÃÂ¡ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ¶ÃÂ£ÃÂÃÂ® <b>ÃÂ¢ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂ¥ÃÂ£ÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂ£ÃÂÃÂCTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂ</b> ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ<br>
      ÃÂ¢ÃÂÃÂ¢ CTKÃÂ¥ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ¥ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¸ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ<br>
      ÃÂ¢ÃÂÃÂ£ ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂÃÂ¯ÃÂ¼ÃÂ<br><br>
      <span style="color:#b45309;font-size:13px;">ÃÂ¢ÃÂÃÂ  ÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ¥ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ»ÃÂ¢ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ<br>
      ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¯PCÃÂ£ÃÂÃÂ®ChromeÃÂ£ÃÂÃÂ§ <b>F12 ÃÂ¢ÃÂÃÂ Application ÃÂ¢ÃÂÃÂ Cookies ÃÂ¢ÃÂÃÂ CTK</b> ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ¨ÃÂ²ÃÂ¼ÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</span>
    </div>
  </div>

  <div class="after">
    <div class="after-title">ÃÂ¢ÃÂÃÂ ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂÃÂ©ÃÂ ÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ</div>
    <div class="after-body">
      jp.indeed.com ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂCTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ¢ÃÂÃÂ CTKÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ¥ÃÂ¥ÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¼ÃÂ£ÃÂÃÂ<br>
      <span style="font-size:13px;color:#166534;">ÃÂ¯ÃÂ¼ÃÂÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¥ÃÂ ÃÂ´ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ¥ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂ¯ÃÂ¾ÃÂ¥ÃÂ¿ÃÂÃÂ¥ÃÂÃÂ¯ÃÂ¯ÃÂ¼ÃÂ</span>
    </div>
  </div>

  <p class="note">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¸ÃÂ£ÃÂÃÂ®URLÃÂ£ÃÂÃÂ¯ÃÂ¤ÃÂ¿ÃÂÃÂ§ÃÂ®ÃÂ¡ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ¬ÃÂ¡ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¿ÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
</body>
</html>"""
    return html
...
def update_ctk_endpoint():
    """CTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¯ÃÂ¾ÃÂ¥ÃÂ¿ÃÂÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂCOWORK_WEBHOOK_TOKENÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂªÃÂÃÂ¨ÃÂ¨ÃÂ¼ÃÂ£ÃÂÃÂ"""
    token = flask_request.args.get("token", "")
    if not COWORK_WEBHOOK_TOKEN or token != COWORK_WEBHOOK_TOKEN:
        return "Unauthorized", 401
    ...
    # POST: CTKÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
    ...
    # CTKÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ¬ÃÂ¡ÃÂ¥ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¯ÃÂ¼ÃÂ
    global _ctk_expired_notified
    with _ctk_expired_notified_lock:
        _ctk_expired_notified = False
...
def send_setup_msg():
    """LINEÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«CTKÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂURLÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ¡ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ§ÃÂÃÂ¨ÃÂ£ÃÂÃÂ»GETÃÂ¥ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂ¯ÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂ"""
    token = flask_request.args.get("token", "")
    if not COWORK_WEBHOOK_TOKEN or token != COWORK_WEBHOOK_TOKEN:
        return "Unauthorized", 401
    setup_url = f"{RAILWAY_SERVICE_URL}/update-ctk-setup?token={COWORK_WEBHOOK_TOKEN}"
    msg = (
        "ÃÂ£ÃÂÃÂCTKÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ° ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ©ÃÂ¡ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ\n\n"
        "IndeedÃÂ£ÃÂÃÂ®CTKÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ\n"
        ...
        "ÃÂ¢ÃÂÃÂ  ÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂ®URLÃÂ£ÃÂÃÂChromeÃÂ£ÃÂÃÂ§ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ\n"
        "ÃÂ¢ÃÂÃÂ¡ ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂ ÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ \n"
        "ÃÂ¢ÃÂÃÂ¢ ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ¥ÃÂÃÂCTKÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ\n\n"
        f"{setup_url}"
    )
    ...
    try:
        ...
        if resp.status_code < 400:
            return "ÃÂ¢ÃÂÃÂ LINEÃÂ£ÃÂÃÂ«ÃÂ©ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ¡ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ", 200
    ...
    def send_test_personal():
        """åäººLINEã«ãã¹ãã¡ãã»ã¼ã¸ãéä¿¡ããï¼GETã§å¼ã³åºãå¯ï¼"""
        token = flask_request.args.get("token", "")
        if not COWORK_WEBHOOK_TOKEN or token != COWORK_WEBHOOK_TOKEN:
            return "Unauthorized", 401
        ...
        msg = flask_request.args.get("msg", "ããã¹ããåäººLINEéç¥ãã¹ãã§ãããã®ã¡ãã»ã¼ã¸ãå±ãã¦ããã°è¨­å®æåã§ãã")
        try:
            resp = requests.post(
                "https://api.line.me/v2/bot/message/push",
            ...
            if resp.status_code < 400:
                return "â åäººLINEã«éä¿¡ãã¾ãã", 200
            return f"LINE API error: {resp.status_code} {resp.text}", 500
        except Exception as e:
